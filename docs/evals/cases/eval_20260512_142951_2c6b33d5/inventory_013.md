...
用户输入："超市买了牛奶1升帮我记进库存"
  ...
  ├── 槽位提取：restock_items 期望含 `[{'name': '牛奶', 'amount': 1, 'unit': 'L', 'merge_mode': 'add'}]` 实际 `['{"name": "牛奶", "amount": 1, "unit": "升"}']` ✗
...
- **效率 §5.4（观测，不计入 overall）**：`metrics` wall_ms=4692.423 tokens=None mcp≈0
